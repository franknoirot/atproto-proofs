...
const OUT = resolve(import.meta.dirname, '../presentation/data.js')
...
async function main() {
  ...
  await writeFile(
    OUT,
    '// Generated by `pnpm present`. Every value here was observed in a real run.\n' +
      'window.DEMO = ' + JSON.stringify(data, null, 1) + '\n',
    'utf8',
  )
  console.log(`\nwrote ${OUT}`)
  console.log('open presentation/index.html in a browser')
}
